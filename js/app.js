document.getElementById('btn-messi').addEventListener('click', function(){
  ...
  const plrSelect = document.getElementById('select-name-1')
...
document.getElementById('btn-neymar').addEventListener('click', function(){
  ...
  const plrSelect = document.getElementById('select-name-2')
...
document.getElementById('btn-mbappe').addEventListener('click', function(){
  ...
  const plrSelect = document.getElementById('select-name-3')
...
document.getElementById('btn-modrich').addEventListener('click', function(){
  ...
  const plrSelect = document.getElementById('select-name-4')
...
document.getElementById('btn-benzema').addEventListener('click', function(){
  ...
  const plrSelect = document.getElementById('select-name-5')
